    ...
    <div class="content">
        ...
        <form method="GET" action="">
            ...
            <div class="row mb-3 g-2 align-items-end">
                ...
                <div class="col-md-3">
                    <label class="form-label mb-1" style="font-size: 0.95em;">Range Jam Nyala (jam)</label>
                    <div class="d-flex justify-content-between mb-1" style="font-size: 0.9em; color: #666;">
                        <span id="jamNyalaMinLabel">20</span>
                        <span id="jamNyalaMaxLabel">160</span>
                    </div>
                    <div id="jamNyalaSlider"></div>
        ...
        $(document).ready(function () {
            ...
            var table = $('#jamNyalaTable').DataTable({
                ...
                columns: [
                    ...
                    { data: 2 }, // TARIP
                    { data: 3 }, // DAYA
                    { data: 4, render: function(data) { return data; } }, // Status (render as HTML)
                    { data: 5 }, // Jam Nyala
                    { data: 6 }, // Tanggal
                    { data: 7 }, // Bulan
                    { data: 8 }  // Tahun
            ...
            // Inisialisasi noUiSlider untuk jam nyala
            var jamNyalaSlider = document.getElementById('jamNyalaSlider');
            var minVal = parseInt($('#jam_nyala_min').val()) || 20;
            var maxVal = parseInt($('#jam_nyala_max').val()) || 160;
            ...
            jamNyalaSlider.noUiSlider.on('update', function(values, handle) {
                ...
                $('#jamNyalaMinLabel').text(min);
                $('#jamNyalaMaxLabel').text(max);
