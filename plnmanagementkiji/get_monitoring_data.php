...
// Get filtered data
$sql = "SELECT IDPEL, NAMA, TARIP, DAYA, KDSWITCHING, TGLBAYAR, PEMKWH, RPPENJ 
        FROM $table_name 
        $where 
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    // Gabungkan tanggal, bulan, tahun menjadi satu kolom (format YYYY-MM-DD)
    $tglbayar = $row['TGLBAYAR'];
    $rppenj = isset($row['RPPENJ']) ? $row['RPPENJ'] : '';
